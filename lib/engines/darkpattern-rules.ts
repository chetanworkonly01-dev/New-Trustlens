...
export const DARK_PATTERN_RULES: DarkPatternRule[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    severity: 'high', regulation: ['EU-GDPR', 'US-CCPA'], detect: 'visual',
  },
  {
  ...
  },
  {
    ...
    severity: 'critical', regulation: ['EU-GDPR', 'US-CCPA'], detect: 'visual',
  },
  {
  ...
  },
  {
    ...
    severity: 'high', regulation: ['US-CCPA'], detect: 'visual',
  },
  {
  ...
  },
  {
    ...
    severity: 'critical', regulation: ['EU-GDPR', 'US-CCPA'], detect: 'dom',
  },
  {
  ...
  },
  {
    ...
    severity: 'high', regulation: ['US-CCPA'], detect: 'journey',
  },
  {
    ...
    severity: 'critical', regulation: ['EU-GDPR', 'US-CCPA'], detect: 'flow',
  },
  {
  ...
  },
  {
    ...
    severity: 'critical', regulation: ['EU-GDPR'], detect: 'dom',
  },
  {
  ...
  },
  {
    ...
    severity: 'low', regulation: ['EU-GDPR', 'US-CCPA'], detect: 'visual',
  },
  {
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    severity: 'critical', regulation: ['US-CCPA'], detect: 'ai',
  },
  {
    ...
    severity: 'high', regulation: ['US-CCPA'], detect: 'ai',
  },
  {
  ...
  },
  {
    ...
    severity: 'critical', regulation: ['US-CCPA'], detect: 'journey',
  },
  {
  ...
  },
  {
    ...
    severity: 'medium', regulation: ['EU-GDPR', 'US-CCPA'], detect: 'visual',
  },
...
export const VISUAL_AI_RULES: DarkPatternRule[] = [
  ...
  },
  {
    ...
    severity: 'critical', regulation: ['US-CCPA'], detect: 'visual',
  },
  {
  ...
  // ── India-Specific Rules (added post-PolicyBazaar audit, May 2026) ──
  {
    ...
    severity: 'high', regulation: ['US-CCPA'], detect: 'textual',
  },
  {
  ...
  },
  {
    ...
    severity: 'medium', regulation: ['US-CCPA'], detect: 'textual',
  },
  {
...
export const CONFIRMSHAMING_PATTERNS = [
  ...
  /i\s*(prefer|choose|want)\s*to\s*(pay\s+full|pay\s+more|miss|lose|stay\s+unprotected|keep\s+paying)/i,
  /i\s*(hate|don'?t\s+care\s+about)\s+(saving|discounts?|deals?|protection|my\s+family)/i,
  /no\s*(,|\.|\s)?\s*i'?m?\s*fine\s*(paying\s+full|paying\s+more|without\s+discount)/i,
  /i'?ll?\s*(pass|skip|decline)\s*(on)?\s*(saving|the\s+discount|this\s+offer|free\s+money)/i,
  // Guilt & Manipulative Opt-Outs
  /i\s+(don'?t\s+want|don'?t\s+need)\s+(to\s+)?(save|protect\s+my|improve\s+my|grow\s+my)/i,
  /no\s+thanks?,?\s+i'?ll?\s+(pay\s+more|miss\s+out|figure\s+it\s+out|stay\s+unprotected)/i,
  /i\s+(already\s+have\s+too\s+much\s+money|don'?t\s+want\s+to\s+save|prefer\s+to\s+pay\s+full)/i,
  /i\s+don'?t\s+want\s+(any\s+)?(discount|deal|savings?|free\s+gift|trial)/i,
  /continue\s+without\s+(saving|the\s+discount|protection|upgrade)/i,
  /i'?m\s+okay\s+paying\s+full\s+price/i,
  /maybe\s+later\s*(,|\s)*i'?ll?\s+pay\s+full/i,
